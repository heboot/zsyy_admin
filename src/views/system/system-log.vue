        ...
        <div class="searchWrapper clearfix">
          <div class="poptip">
            <Poptip trigger="hover" content="请输入用户名搜索" placement="bottom-start">
              <Input placeholder="请输入用户名搜索" v-model="filterSearch.adminName" /></Input>
            </Poptip>
          </div>
          <div class="poptip">
          ...
          <!-- module -->
          <div class="btns">
            <Button type="primary" @click="searchByFilter"><Icon type="ios-search" style="font-size:16px"/>查询</Button>
          </div>
        </div>
      </Row>
      <Row>
  ...
  data() {
    return {
      moduleArr: [
        ...
        { status: 5, text: 'PRODUCT' },
        { status: 6, text: 'SYSTEM' },
        { status: 7, text: 'ADDITIONAL' },
        { status: 9, text: 'REPORT' },
        { status: -1, text: '全部' }
      ],
      filterSearch: {
        pageNo: 1,
